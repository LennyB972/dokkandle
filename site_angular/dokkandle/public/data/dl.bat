...
REM --- Définir la borne supérieure ---
set "maxId=1032001"

REM --- Liste des IDs à télécharger ---
setlocal enabledelayedexpansion
for /L %%i in (1000001,10,!maxId!) do (
    REM --- Construire l'URL ---
    set "url=https://dokkan.wiki/api/cards/%%i"

    REM --- Télécharger le fichier JSON avec curl ---
    curl -s -A "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/122.0.0.0 Safari/537.36" "!url!" -o "downloads\%%i.json"
